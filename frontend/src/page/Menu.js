...
const Menu = () => {
  ...
  return (
    <div className="p-2 md:p-4">
      {productDisplay ? ( // Check if productDisplay is not undefined
        <div className="w-full max-w-4xl m-auto md:flex bg-white">
          <div className="max-w-sm  overflow-hidden w-full p-5">
            <img
              src={productDisplay.image}
              className="hover:scale-105 transition-all h-full"
              alt={productDisplay.name} // Add alt attribute for accessibility
            />
          </div>
        ...
        <p>No product found</p> // Render a message if productDisplay is undefined
      )}
